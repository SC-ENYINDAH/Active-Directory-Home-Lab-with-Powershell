@{
    ...
    NestedModules     = @(
        '$PSScriptRoot\code\Modules\root_schema_generator.psm1',
        '$PSScriptRoot\code\Modules\Hold_Envariables.psm1',
        '$PSScriptRoot\code\Modules\password_security_policy.psm1',
        '$PSScriptRoot\code\Modules\installAD.psm1',
        '$PSScriptRoot\code\Modules\CreateUsers.psm1',
        '$PSScriptRoot\code\Modules\CreateGroups.psm1',
        '$PSScriptRoot\code\Modules\OU.psm1'
    )
